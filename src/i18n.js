...
const dict = {
  fa: {
    ...
    'hero.title1': 'توان و تناسب، با', 'hero.title2': 'میلانو',
    ...
    'shop.reset': 'پاک کردن فیلترها', 'shop.count': 'کالا', 'shop.sold': 'فروش', 'shop.low': 'فقط {n} عدد ماند!',
    'shop.fast': 'ارسال سریع', 'shop.guarantee': '۷ روز ضمانت بازگشت', 'shop.secure': 'پرداخت امن',
    'blog.title': 'مجله میلانو', 'blog.empty': 'هنوز پست منتشرشده‌ای وجود ندارد.',
    ...
    'ord.shipCard': 'پیگیری مرسوله', 'ord.carrier': 'شرکت باربری', 'ord.tracking': 'کد رهگیری مرسوله', 'ord.timeline': 'گاه‌شمار وضعیت',
    'ord.tl_created': 'ثبت سفارش', 'ord.tl_paid': 'پرداخت موفق', 'ord.tl_shipped': 'ارسال شد', 'ord.tl_cancelled': 'لغو/استرداد',
    'ct.title': 'با ما در تماس باشید', 'ct.lead': 'پشتیبانی سفارش، همکاری فروشگاهی یا سوال درباره سایز — پیام شما مستقیم در میز کار پنل میلانو ثبت می‌شود.',
    'ct.form': 'فرم تماس', 'ct.user': 'نام شما', 'ct.subject': 'موضوع', 'ct.body': 'متن پیام', 'ct.send': 'ارسال پیام',
    'ct.done': 'پیام شما ثبت شد ✅', 'ct.doneSub': 'تیم میلانو معمولاً کمتر از ۲۴ ساعت پاسخ می‌دهد.', 'ct.another': 'ارسال پیام دیگر',
    'ft.shop': 'سبد خرید و پرداخت', 'ft.login': 'ورود پنل مدیریت', 'ft.rights': '© میلانو Meelano — توان و تناسب',
  ...
  en: {
    ...
    'hero.title1': 'Power & fit, with', 'hero.title2': 'Meelano',
    ...
    'shop.reset': 'Clear filters', 'shop.count': 'items', 'shop.sold': 'sold', 'shop.low': 'Only {n} left!',
    'shop.fast': 'Fast shipping', 'shop.guarantee': '7-day returns', 'shop.secure': 'Secure payment',
    'blog.title': 'Meelano Journal', 'blog.empty': 'No published posts yet.',
    ...
    'ord.shipCard': 'Shipment tracking', 'ord.carrier': 'Carrier', 'ord.tracking': 'Tracking code', 'ord.timeline': 'Status timeline',
    'ord.tl_created': 'Order placed', 'ord.tl_paid': 'Payment confirmed', 'ord.tl_shipped': 'Shipped', 'ord.tl_cancelled': 'Cancelled / refunded',
    'ct.title': 'Get in touch', 'ct.lead': 'Order support, wholesale or sizing questions — your message lands directly in the Meelano admin desk.',
